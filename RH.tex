...
\[
\tau(s,n+2,m)=a_{n}\,\tau(s,n,m),
\]
where $a_{n}$ is constant.
\end{proposition}

\begin{proof}
By Proposition~\ref{prop:sech_bell_at_infinity} and by Proposition~\ref{prop:sech_bell_at_origin} the ratios are independent of $s$ and rely only on symmetric values in $n$ and $m$.
\end{proof}

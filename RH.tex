...
The recursions Theorems~\ref{thm:ibp1} and~\ref{thm:ibp2} are linear in $\sigma$ and $\tau$. To extract the nonlinear (quadratic) structure that defines the infinite product factors, we interpret the coefficient $a_{n,m}(s)$ as a normalized version:
\begin{equation}\label{eq:coeff_def}
a_{n,m}(s) := \frac{\sigma(s,n+2,m)}{\sigma(s,n,m)}.
\end{equation}
